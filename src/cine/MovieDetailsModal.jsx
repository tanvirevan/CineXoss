...
export default function MovieDetailsModal({ onClose, onCartAdd }) {
  return (
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[984px] p-4 max-h-[90vh] overflow-auto">
              <div className="bg-white shadow-md dark:bg-[#12141D] rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
                  <img
                      ...
                      alt="Movie Image" // Static alt text
                  />
                  <div className="p-5 lg:p-11">
                      <div className="">
                          <h2 className="text-3xl lg:text-[50px] mb-2 font-bold">
                              Movie Title {/* Static title */}
                          </h2>
                      ...
                      <p className="text-sm lg:text-base mb-8 lg:mb-16">
                          Movie description goes here. {/* Static description */}
                      </p>
                      <div className="grid lg:grid-cols-2 gap-2">
                          <a
                              className="bg-primary rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#171923] font-semibold text-sm"
                              href="#"
                              onClick={(e) => onCartAdd(e, {})} // Empty movie object
                          >
